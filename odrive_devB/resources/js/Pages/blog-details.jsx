            ...
            <div className="col-xl-8 mt-65">
              <div className="blog-details-content">
                ...
                <div className="image my-35">
                  <img src="/images/news/blog-details.jpg" alt="Blog" />
                </div>
                <p>
                ...
                <div className="next-prev-post mb-55">
                  <div className="prev-post wow fadeInLeft delay-0-2s">
                    <div className="image">
                      <img src="/images/news/prev-post.jpg" alt="News" />
                    </div>
                  ...
                  <Link href="/blog-grid" className="show-all">
                  ...
                  <div className="next-post wow fadeInRight delay-0-2s">
                    <div className="image">
                      <img src="/images/news/next-post.jpg" alt="News" />
                    </div>
                    <div className="content">
                      <h6>
                        <Link href="/blog-details">
                ...
                <Slider {...newsSlider} className="news-slider mb-60">
                  <div className="news-item wow fadeInUp delay-0-2s">
                    <div className="image">
                      <img
                        src="/images/news/news-slider1.jpg"
                        alt="News"
                      />
                      <span className="date">
                        <b>25</b> July
                  ...
                  <div className="news-item wow fadeInUp delay-0-4s">
                    <div className="image">
                      <img
                        src="/images/news/news-slider2.jpg"
                        alt="News"
                      />
                      <span className="date">
                        <b>26</b> July
