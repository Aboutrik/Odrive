...
import TrendyProducts from "@/src/components/istotope/TrendyProducts";
import PopularProducts from "@/src/components/istotope/PopularProducts";
          ...
          <div className="row justify-content-center">
            <div className="col-xl-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/images/offers/offer-banner-bg4.jpg)",
                }}
              >
                <div className="content mb-0 ml-auto">
                  <span className="sub-title">100% Fresh</span>
                  <h3>Vegetables</h3>
                  <Link href="/shop-grid" className="theme-btn style-three">
            ...
            <div className="col-xl-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/images/offers/offer-banner-bg5.jpg)",
                }}
              >
            ...
            <div className="col-xl-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/images/offers/offer-banner-bg6.jpg)",
                }}
              >
                <div className="content mb-0">
                  <span className="sub-title">100% Fresh</span>
            ...
            <div className="row justify-content-center">
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="product-category-item wow fadeInUp delay-0-2s">
                  <div className="image">
                    <img
                      src="/images/products/product28.png"
                      alt="Product"
                    />
                  </div>
                  <div className="content">
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="product-category-item wow fadeInUp delay-0-3s">
                  <div className="image">
                    <img
                      src="/images/products/product29.png"
                      alt="Product"
                    />
                  </div>
                  <div className="content">
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="product-category-item wow fadeInUp delay-0-4s">
                  <div className="image">
                    <img
                      src="/images/products/product30.png"
                      alt="Product"
                    />
                  </div>
                  <div className="content">
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="product-category-item wow fadeInUp delay-0-7s">
                  <div className="image">
                    <img
                      src="/images/products/product33.png"
                      alt="Product"
                    />
                  </div>
                  <div className="content">
      ...
      <section className="special-offer-three">
        <div className="container-fluid">
          <div
            ...
            style={{
              backgroundImage: "url(/images/offers/offer-bg.jpg)",
            }}
          >
            ...
            <img
              className="offer-bg"
              src="/images/offers/special-offer-bg-two.png"
              alt="Offer BG"
            />
          </div>
        </div>
        ...
        <div className="container-fluid">
          <div className="bg-lighter-two overflow-hidden rel z-1 px-sm-4 px-2">
            <Slider {...clientLogo} className="client-logo-wrap py-60">
              <div className="client-logo-item color-hover">
                <Link href="/contact">
                    ...
                    <img
                      src="/images/client-logo/client-logo-two-1.png"
                      alt="Client Logo"
                    />
              ...
              <div className="client-logo-item color-hover">
                <Link href="/contact">
                    ...
                    <img
                      src="/images/client-logo/client-logo-two-2.png"
                      alt="Client Logo"
                    />
              ...
              <div className="client-logo-item color-hover">
                <Link href="/contact">
                    ...
                    <img
                      src="/images/client-logo/client-logo-two-3.png"
                      alt="Client Logo"
                    />
              ...
              <div className="client-logo-item color-hover">
                <Link href="/contact">
                    ...
                    <img
                      src="/images/client-logo/client-logo-two-4.png"
                      alt="Client Logo"
                    />
              ...
              <div className="client-logo-item color-hover">
                <Link href="/contact">
                    ...
                    <img
                      src="/images/client-logo/client-logo-two-5.png"
                      alt="Client Logo"
                    />
              ...
              <div className="client-logo-item color-hover">
                <Link href="/contact">
                    ...
                    <img
                      src="/images/client-logo/client-logo-two-6.png"
                      alt="Client Logo"
                    />
            ...
            <div className="client-logo-shapes">
              <img
                className="shape-one"
                src="/images/shapes/cl-shape-two1.png"
                alt="Shape"
              />
              <img
                className="shape-two"
                src="/images/shapes/cl-shape-two2.png"
                alt="Shape"
              />
              <img
                className="shape-three"
                src="/images/shapes/cl-shape-two3.png"
                alt="Shape"
              />
              <img
                className="shape-four"
                src="/images/shapes/cl-shape-two4.png"
                alt="Shape"
              />
              <img
                className="shape-five"
                src="/images/shapes/cl-shape-two5.png"
                alt="Shape"
              />
              <img
                className="shape-six"
                src="/images/shapes/cl-shape-two6.png"
                alt="Shape"
              />
            </div>
          </div>
