  ...
  return (
    <Layout header={2}>
      <section
        ...
        style={{ background: "url(/images/slider/slider-two-bg.jpg)" }}
      >
      ...
      <section className="about-section-two rel z-1 pt-130 rpt-100">
            ...
            <div className="col-lg-6">
              <div className="about-two-image wow fadeInUp delay-0-2s">
                ...
                <img
                  ...
                  src="/images/about/about-left-over.png"
                  alt="About"
                />
              </div>
            </div>
                  ...
                  <div className="row">
                    <div className="col-xl-4 col-md-6">
                      <div className="about-feature-item wow fadeInUp delay-0-6s">
                        ...
                        <img src="/images/about/arrow.png" alt="Arrow" />
                      </div>
                    </div>
                    <div className="col-xl-4 col-md-6">
        ...
        <div className="about-shapes">
          <img src="/images/shapes/about-shape1.png" alt="Shape" />
          <img src="/images/shapes/about-shape2.png" alt="Shape" />
        </div>
      </section>
      {/* About Section End */}
      ...
      <div className="client-top-image">
        <img
          className="w-100"
          src="/images/background/client-top.png"
          alt="Client Top"
        />
      </div>
      {/* Image Section End */}
      ...
      <section className="product-section-two rel z-1 pt-130 rpt-100">
        ...
        <div className="product-shapes">
          <img
            className="shape-one"
            src="/images/shapes/product-shape1.png"
            alt="Shape"
          />
          <img
            className="shape-two"
            src="/images/shapes/product-shape2.png"
            alt="Shape"
          />
        </div>
      </section>
      ...
      <section className="about-section-three rel z-1 py-130 rpy-100">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 text-lg-right">
              <div className="about-video wow fadeInRight delay-0-2s">
                ...
                <img
                  className="bg-shape"
                  src="/images/about/about-bg-shape.png"
                  alt="Shape"
                />
              </div>
            </div>
        ...
        <img
          src="/images/shapes/about-three.png"
          alt="Shape"
          className="shape"
        />
      </section>
          ...
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/images/offers/offer-banner-bg1.jpg)",
                }}
              >
            ...
            <div className="col-xl-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/images/offers/offer-banner-bg2.jpg)",
                }}
              >
                <div className="content mb-0">
                  <span className="sub-title">35% Off Foods</span>
            ...
            <div className="col-xl-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/images/offers/offer-banner-bg3.jpg)",
                }}
              >
                <div className="content mb-0">
                  <span className="sub-title">35% Off Foods</span>
      ...
      <section
        ...
        style={{
          backgroundImage: "url(/images/background/special-offer-bg.jpg)",
        }}
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-4">
              <div className="special-offer-left text-center rmb-35 wow fadeInUp delay-0-2s">
                <img
                  src="/images/offers/special-offer-left.png"
                  alt="Offer"
                />
              </div>
            </div>
        ...
        <img
          className="shape-one"
          src="/images/shapes/special-offer1.png"
          alt="Shape"
        />
        <img
          className="shape-two"
          src="/images/shapes/special-offer2.png"
          alt="Shape"
        />
      </section>
      {/* Special Offer End */}
      ...
      <section className="what-we-provide rel z-1 pt-130 rpt-100">
          ...
          <div className="row justify-content-between">
            <div className="col-xl-3 col-md-4">
              <div className="what-we-provide-left wow fadeInUp delay-0-2s">
                <div className="ww-provide-item">
                  <div className="icon">
                    <img src="/images/services/icon1.png" alt="Icon" />
                  </div>
                  <h4>
                ...
                <div className="ww-provide-item">
                  <div className="icon">
                    <img src="/images/services/icon2.png" alt="Icon" />
                  </div>
                  <h4>
            ...
            <div className="col-xl-5 col-md-4 align-self-center">
              <div className="what-we-provide-images rmt-10 rmb-55 wow fadeInUp delay-0-4s">
                <img
                  src="/images/services/what-we-provide.png"
                  alt="Service"
                />
                <img
                  className="offer"
                ...
                <img
                  className="bg"
                  src="/images/services/service-center-bg.png"
                  alt="Backgroound"
                />
              </div>
            </div>
            <div className="col-xl-3 col-md-4">
              <div className="what-we-provide-right wow fadeInUp delay-0-6s">
                <div className="ww-provide-item">
                  <div className="icon">
                    <img src="/images/services/icon3.png" alt="Icon" />
                  </div>
                  <h4>
                ...
                <div className="ww-provide-item">
                  <div className="icon">
                    <img src="/images/services/icon4.png" alt="Icon" />
                  </div>
                  <h4>
        ...
        <div className="ww-provide-shapes">
          <img
            className="shape-one"
            src="/images/shapes/ww-provide1.png"
            alt="Shape"
          />
          <img
            className="shape-two"
            src="/images/shapes/ww-provide2.png"
            alt="Shape"
          />
          <img
            className="shape-three"
            src="/images/shapes/ww-provide3.png"
            alt="Shape"
          />
        </div>
      </section>
          ...
          <div className="row align-items-end pb-35">
            ...
            <div className="col-lg-4 text-lg-right">
              <div className="more-news-btn mb-25">
                <Link href="/blog-grid" className="theme-btn style-two">
        ...
        <div className="row no-gutters">
          <div className="col-lg-6">
            <div
              ...
              style={{
                backgroundImage: "url(/images/video/cta-video-left.jpg)",
              }}
            >
              <div className="content">
                <div className="section-title mb-30">
          ...
          <div className="col-lg-6">
            <div
              ...
              style={{
                backgroundImage: "url(/images/video/cta-video-right.jpg)",
              }}
            >
              <div className="content">
