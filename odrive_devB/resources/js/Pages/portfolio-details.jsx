        ...
        <div className="container">
          <div className="portfolio-details-content">
            <div className="image mb-50 wow fadeInUp delay-0-2s">
              <img
                src="/images/gellery/portfolio-details.jpg"
            ...
            <div className="portfolio-next-prev pt-50 rpt-40">
              <div className="prev-portfolio wow fadeInLeft delay-0-2s">
                <div className="image">
                  <img
                    src="/images/gellery/portfolio-prev.jpg"
                    alt="Portfolio"
                  />
                </div>
              ...
              <Link href="/portfolio-grid"  className="show-all">
              ...
              <div className="next-portfolio wow fadeInRight delay-0-2s">
                ...
                <div className="image">
                  <img
                    src="/images/gellery/portfolio-next.jpg"
                    alt="News"
                  />
                </div>
              </div>
