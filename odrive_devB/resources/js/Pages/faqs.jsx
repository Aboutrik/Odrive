    ...
    <Layout>
      ...
      <section className="what-we-want rel z-1 bg-lighter pt-130 rpt-100 pb-95 rpb-65">
          ...
          <div className="row align-items-center">
            <div className="col-xl-6 col-lg-5">
              <div className="what-we-want-content mb-30 rmb-65 wow fadeInUp delay-0-2s">
                ...
                <Link href="/services" className="read-more color-secondary">
                  ...
                  <div className="col-md-6">
                    <div className="about-feature-item style-two wow fadeInUp delay-0-4s">
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(/images/features/feature-bg.jpg)",
                        }}
                      />
                    </div>
                  </div>
        ...
        <div className="what-we-want-shapes">
          <img
            className="shape-one"
            src="/images/shapes/www-shape1.png"
            alt="Shape"
          />
          <img
            className="shape-two"
            src="/images/shapes/www-shape2.png"
            alt="Shape"
          />
        </div>
      </section>
      ...
      <section className="faq-section rel z-1 pt-130 rpt-100">
        ...
        <div className="faq-shapes">
          <img
            className="shape-one"
            src="/images/shapes/faq-shape1.png"
            alt="Shape"
          />
          <img
            className="shape-two"
            src="/images/shapes/faq-shape2.png"
            alt="Shape"
          />
          <img
            className="shape-three"
            src="/images/shapes/faq-shape3.png"
            alt="Shape"
          />
          <img
            className="shape-four"
            src="/images/shapes/faq-shape4.png"
            alt="Shape"
          />
        </div>
      </section>
