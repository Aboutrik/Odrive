            ...
            <div className="col-xl-8 mt-65">
              <div className="service-details-content">
                <div className="image wow fadeInUp delay-0-2s">
                  <img
                    src="/images/services/service-details1.jpg"
                    alt="Service"
                  />
                </div>
                ...
                <div className="image pt-50 wow fadeInUp delay-0-2s">
                  <img
                    src="/images/services/service-details2.jpg"
                    alt="Service"
                  />
                </div>
              ...
              <div className="service-sidebar mt-65">
                ...
                <div className="widget widget-cta wow fadeInUp delay-0-2s">
                  <div className="cta-widget-content text-white">
                    ...
                    <img src="/images/shapes/wave-white.png" alt="Wave" />
                    <br />
                    <Link href="/contact" className="theme-btn style-three bg-white mt-30">
                    ...
                    <img
                      className="bg"
                      src="/images/widgets/cta-widget.png"
                      alt="Flower"
                    />
                  </div>
                </div>
