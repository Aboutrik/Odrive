      ...
      <section className="contact-info-area rel z-1 pt-130 rpt-100">
        <div className="container">
          <div className="section-title contact-title mb-50 wow fadeInUp delay-0-2s">
            <span className="sub-title mb-15">En une touche</span>
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-6s">
                ...
                <div className="content">
                  <h4>Phone Us</h4>
                  <a href="callto:+225 0757580022">+225 0757580022</a>
                  <br />
                  <a href="callto:+225 0952581093">+225 0952581093</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="contact-shapes">
          <img
            className="leafs"
            src="/images/shapes/contact-leafs.png"
            alt="Leafs"
          />
          <img
            className="pumpkin"
            src="/images/shapes/pumpkin.png"
            alt="pumpkin"
          />
        </div>
      </section>
            ...
            <div className="col-lg-6">
              ...
              >
                <div className="section-title contact-title mb-55">
                  <span className="sub-title mb-15">Depuis la plateforme</span>
